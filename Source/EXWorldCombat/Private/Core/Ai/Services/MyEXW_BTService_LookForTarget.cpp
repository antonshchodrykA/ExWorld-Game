...
#include "MyEXW_BTService_LookForTarget.h"
// BT
...
void UMyEXW_BTService_LookForTarget::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
