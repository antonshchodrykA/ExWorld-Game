 ...
 * +--------+-------------+
 */
class  SMSSViewportToolBarComboMenu : public SCompoundWidget 
{
public:
	SLATE_BEGIN_ARGS(SMSSViewportToolBarComboMenu) : _BlockLocation(EMultiBlockLocation::Start), _MinDesiredButtonWidth(-1.0f) {}
