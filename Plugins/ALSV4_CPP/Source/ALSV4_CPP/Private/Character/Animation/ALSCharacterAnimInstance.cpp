...
void UALSCharacterAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	CharacterInformation.RightFootOffset = Character->FootIKAdjustment.RightFootOffset;
	CharacterInformation.LeftFootOffset = Character->FootIKAdjustment.LeftFootOffset;
	CharacterInformation.PelvisOffset = Character->FootIKAdjustment.PelvisOffset;
	CharacterClass = Character->Class;
	CharacterGender = Character->Gender;
	CharacterIsWeaponEquipped = Character->bWeaponEquipped;
	CharacterIsInCombat = Character->bIsInCombat;
...
void UALSCharacterAnimInstance::UpdateLayerValues()
{
	...
	// Set the Legs Override weights
	LayerBlendingValues.Legs_Add = GetCurveValue(FName(TEXT("Layering_Legs_Add")));
	// Set the Pelvis Override weights
	LayerBlendingValues.Pelvis_Add = GetCurveValue(FName(TEXT("Layering_Pelvis_Add")));
...
void UALSCharacterAnimInstance::ResetIKOffsets(float DeltaSeconds)
{
	...
	FootIKValues.FootOffset_L_Location = FMath::VInterpTo(FootIKValues.FootOffset_L_Location,
	                                                      FVector::ZeroVector, DeltaSeconds, 15.0f) + CharacterInformation.LeftFootOffset;
	FootIKValues.FootOffset_R_Location = FMath::VInterpTo(FootIKValues.FootOffset_R_Location,
	                                                      FVector::ZeroVector, DeltaSeconds, 15.0f) + CharacterInformation.RightFootOffset;
