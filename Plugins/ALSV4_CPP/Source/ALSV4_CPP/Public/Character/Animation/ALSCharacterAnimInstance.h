...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, meta = (BlueprintThreadSafe, HideSelfPin, CompactNodeTitle = "IK Values"), Category = "IK")
	FORCEINLINE FALSAnimGraphFootIK GetAdjustedFootIKValues() const
	{
		FALSAnimGraphFootIK AdjustedFootIKValues = FootIKValues;
		AdjustedFootIKValues.FootOffset_L_Location += CharacterInformation.LeftFootOffset;
		AdjustedFootIKValues.FootOffset_R_Location += CharacterInformation.RightFootOffset;
		AdjustedFootIKValues.PelvisOffset += CharacterInformation.PelvisOffset;
		return AdjustedFootIKValues;
	};
...
public:
	...
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Read Only Data|Character Information")
	EEXWClass CharacterClass = EEXWClass::C_Other;

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Read Only Data|Character Information")
	EEXWGender CharacterGender = EEXWGender::G_Male;

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Read Only Data|Character Information")
	bool CharacterIsWeaponEquipped = false;

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = "Read Only Data|Character Information")
	bool CharacterIsInCombat = false;
